package power.audio.pro.music.player.equalizer;
...
import power.audio.pro.music.player.DBHelper.DbHelperEqualizer;
...
public class EqualizerHelper {
    ...
    public void storeLastEquSetting(EqualizerSetting equSetting){
        ...
        MainApplication.getPref().edit().putString("pref_last_equ_setting",jsonSetting).apply();
    }

    public EqualizerSetting getLastEquSetting(){
        String jsonString = MainApplication.getPref().getString("pref_last_equ_setting", "");
