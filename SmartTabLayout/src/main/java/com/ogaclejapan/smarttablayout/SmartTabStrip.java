...
class SmartTabStrip extends LinearLayout {
    ...
    SmartTabStrip(Context context, AttributeSet attrs) {
        ...
        indicatorAlwaysInCenter = a.getBoolean(R.styleable.SmartTabLayout_stl_indicatorAlwaysInCenter, indicatorAlwaysInCenter);
        indicatorWithoutPadding = a.getBoolean(R.styleable.SmartTabLayout_stl_indicatorWithoutPadding, indicatorWithoutPadding);
        indicatorInFront = a.getBoolean(R.styleable.SmartTabLayout_stl_indicatorInFront, indicatorInFront);
        indicationInterpolatorId = a.getInt(R.styleable.SmartTabLayout_stl_indicatorInterpolation, indicationInterpolatorId);
        indicatorGravity = a.getInt(R.styleable.SmartTabLayout_stl_indicatorGravity, indicatorGravity);
        indicatorColor = a.getColor(R.styleable.SmartTabLayout_stl_indicatorColor, indicatorColor);
        indicatorColorsId = a.getResourceId(R.styleable.SmartTabLayout_stl_indicatorColors, indicatorColorsId);
        indicatorThickness = a.getDimensionPixelSize(R.styleable.SmartTabLayout_stl_indicatorThickness, indicatorThickness);
        indicatorWidth = a.getLayoutDimension(R.styleable.SmartTabLayout_stl_indicatorWidth, indicatorWidth);
        indicatorCornerRadius = a.getDimension(R.styleable.SmartTabLayout_stl_indicatorCornerRadius, indicatorCornerRadius);
        overlineColor = a.getColor(R.styleable.SmartTabLayout_stl_overlineColor, overlineColor);
        overlineThickness = a.getDimensionPixelSize(R.styleable.SmartTabLayout_stl_overlineThickness, overlineThickness);
        underlineColor = a.getColor(R.styleable.SmartTabLayout_stl_underlineColor, underlineColor);
        underlineThickness = a.getDimensionPixelSize(R.styleable.SmartTabLayout_stl_underlineThickness, underlineThickness);
        dividerColor = a.getColor(R.styleable.SmartTabLayout_stl_dividerColor, dividerColor);
        dividerColorsId = a.getResourceId(R.styleable.SmartTabLayout_stl_dividerColors, dividerColorsId);
        dividerThickness = a.getDimensionPixelSize(R.styleable.SmartTabLayout_stl_dividerThickness, dividerThickness);
        drawDecorationAfterTab = a.getBoolean(R.styleable.SmartTabLayout_stl_drawDecorationAfterTab, drawDecorationAfterTab);
        a.recycle();
