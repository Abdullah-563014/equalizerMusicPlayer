...
public class SongAdapter extends RecyclerView.Adapter<SongAdapter.SongViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SongViewHolder holder, int position) {
        ...
        holder.songName.setText(getSpannable(songDetail.getTitle()));
        holder.songArtistAndDuration.setText(getSpannable(NvpUtils.formatTimeDuration(songDetail.getDuration()) + " - " + songDetail.getArtist()));
    ...
    public void add(List<SongDetail> songDetails) {
        mSongDetails.beginBatchedUpdates();
